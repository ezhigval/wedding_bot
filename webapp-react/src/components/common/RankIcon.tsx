...
export default function RankIcon({ rank, className = '' }: RankIconProps) {
  ...
  if (rank === 'Незнакомец') {
    // Незнакомец - закрытое лицо, маска или капюшон, загадочный вид
    return (
      <svg
        width={iconSize}
        height={iconSize}
      ...
      >
        ...
        <path
          ...
          strokeWidth="1.5"
        />
        {/* Вопросительные знаки вокруг (загадочность) */}
        <circle cx="8" cy="18" r="1.5" fill="#999" opacity="0.6" />
        <circle cx="32" cy="18" r="1.5" fill="#999" opacity="0.6" />
      </svg>
    )
  }
  
  if (rank === 'Ты хто?') {
    // Ты хто? - удивленное лицо, большой вопросительный знак
    return (
      <svg
        width={iconSize}
        height={iconSize}
      ...
      >
        ...
        <circle cx="16" cy="20" r="3" fill="#535353" />
        <circle cx="24" cy="20" r="3" fill="#535353" />
        <circle cx="16" cy="19.5" r="1.2" fill="#FFF" />
        <circle cx="24" cy="19.5" r="1.2" fill="#FFF" />
        {/* Рот - овальный, удивленный */}
        <ellipse cx="20" cy="26" rx="3" ry="4" fill="#535353" />
        {/* Большой вопросительный знак над головой */}
        <path
          d="M 20 6 Q 18 4 16 6 Q 14 8 16 10 Q 18 12 20 10 Q 22 12 24 10 Q 26 8 24 6 Q 22 4 20 6"
          stroke="#FF6B6B"
          strokeWidth="2.5"
          fill="none"
          strokeLinecap="round"
        />
        <circle cx="20" cy="13" r="1.5" fill="#FF6B6B" />
        {/* Точка внизу */}
    ...
    return (
      ...
      >
        ...
        <path
          ...
          strokeLinecap="round"
        />
        <circle cx="35.5" cy="30" r="0.8" fill="#FF6B6B" />
      </svg>
    )
  }
  
  if (rank === 'Бедный родственник') {
    // Бедный родственник - грустное лицо, простая шапка, может быть заплатка
    return (
      <svg
        width={iconSize}
        height={iconSize}
      ...
      >
        ...
        <path d="M 14 20 Q 16 18 18 20" stroke="#535353" strokeWidth="2" fill="none" strokeLinecap="round" />
        <path d="M 22 20 Q 24 18 26 20" stroke="#535353" strokeWidth="2" fill="none" strokeLinecap="round" />
        {/* Слезы */}
        <circle cx="15" cy="22" r="1" fill="#87CEEB" opacity="0.8" />
        <circle cx="25" cy="22" r="1" fill="#87CEEB" opacity="0.8" />
        {/* Рот - грустный, опущенный вниз */}
        <path d="M 16 26 Q 20 23 24 26" stroke="#535353" strokeWidth="2" fill="none" strokeLinecap="round" />
        {/* Простая шапка с заплаткой */}
        <rect x="10" y="12" width="20" height="8" rx="2" fill="#8B4513" stroke="#654321" strokeWidth="1" />
        <ellipse cx="20" cy="12" rx="10" ry="3" fill="#8B4513" />
        {/* Заплатка на шапке */}
        <rect x="15" y="13" width="6" height="4" rx="1" fill="#654321" opacity="0.6" />
        <line x1="17" y1="13" x2="19" y2="17" stroke="#8B4513" strokeWidth="0.5" />
        <line x1="19" y1="13" x2="21" y2="17" stroke="#8B4513" strokeWidth="0.5" />
      </svg>
    )
  }
  
  if (rank === 'Братуха') {
    // Братуха - уверенное лицо, кепка, может быть солнечные очки
    return (
      <svg
        width={iconSize}
        height={iconSize}
      ...
      >
        {/* Голова */}
        <circle cx="20" cy="22" r="10" fill="#FFE9AD" stroke="#535353" strokeWidth="2" />
        {/* Глаза - уверенные, или солнечные очки */}
        <ellipse cx="16" cy="20" rx="2.5" ry="3" fill="#535353" />
        <ellipse cx="24" cy="20" rx="2.5" ry="3" fill="#535353" />
        ...
        {/* Козырек кепки */}
        <ellipse cx="20" cy="18" rx="8" ry="2" fill="#000" opacity="0.7" />
        {/* Логотип на кепке (звездочка) */}
        <path
          d="M 20 14 L 20.5 15.5 L 22 15 L 20.5 16 L 21 17.5 L 20 16.5 L 19 17.5 L 19.5 16 L 18 15 L 19.5 15.5 Z"
          fill="#FFD700"
        />
      </svg>
    )
  ...
  if (rank === 'Батя в здании') {
    // Батя в здании - серьезное лицо, корона, борода, властный вид
    return (
      <svg
        width={iconSize}
        height={iconSize}
      ...
      >
        {/* Голова */}
        <circle cx="20" cy="22" r="10" fill="#FFE9AD" stroke="#535353" strokeWidth="2" />
        {/* Глаза - серьезные, уверенные, пронзительные */}
        ...
        <path d="M 13 17 Q 16 16 18 17" stroke="#535353" strokeWidth="2" fill="none" strokeLinecap="round" />
        <path d="M 22 17 Q 24 16 27 17" stroke="#535353" strokeWidth="2" fill="none" strokeLinecap="round" />
        {/* Рот - серьезная улыбка, может быть усы */}
        <path d="M 14 26 Q 20 29 26 26" stroke="#535353" strokeWidth="2" fill="none" strokeLinecap="round" />
        {/* Усы */}
        <path d="M 16 25 Q 18 24 20 25" stroke="#8B4513" strokeWidth="1.5" fill="none" strokeLinecap="round" />
        <path d="M 20 25 Q 22 24 24 25" stroke="#8B4513" strokeWidth="1.5" fill="none" strokeLinecap="round" />
        {/* Корона - роскошная */}
        <path
        ...
        <circle cx="15" cy="12" r="1.5" fill="#FF1493" />
        <circle cx="20" cy="9" r="2" fill="#00CED1" />
        <circle cx="25" cy="12" r="1.5" fill="#FF1493" />
        {/* Борода - пышная, властная */}
        <path
          d="M 14 28 Q 20 35 26 28 Q 20 38 14 28"
          fill="#8B4513"
          stroke="#654321"
          strokeWidth="1.5"
        />
        {/* Разделение бороды */}
        <line x1="20" y1="28" x2="20" y2="35" stroke="#654321" strokeWidth="0.5" opacity="0.5" />
      </svg>
    )
  }
  ...
  return (
    ...
    >
      ...
      <path
        ...
        opacity="1"
      />
      {/* Шрамы (опционально, для крутизны) */}
