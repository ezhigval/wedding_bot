...
Vite автоматически проксирует запросы к `/api` на `http://localhost:10000` (Go backend).
...
После сборки файлы попадают в `../webapp/`, откуда основной Go-сервис раздает их как статические файлы.
