...
2. Backend принимает либо `multipart/form-data` из Mini App, либо скачивает бинарный файл из Telegram по `file_id`.
3. Оба канала сходятся в одну папку Google Drive.
