	...
	specs := []managedSheetSpec{
		...
		},
		{
			...
			headers: []managedSheetHeaderSpec{
				...
				{canonical: "source", aliases: []string{"source", "photo_source"}},
				{canonical: "drive_file_id", aliases: []string{"drive_file_id", "file_id", "google_drive_file_id"}},
				{canonical: "drive_url", aliases: []string{"drive_url", "drive_link", "web_view_link"}},
				{canonical: "file_name", aliases: []string{"file_name", "filename", "name"}},
				{canonical: "mime_type", aliases: []string{"mime_type", "content_type"}},
				{canonical: "file_size", aliases: []string{"file_size", "size"}},
				{canonical: "original_ref", aliases: []string{"original_ref", "original_reference", "telegram_file_id", "payload"}},
			},
		},
	}
